...
--> statement-breakpoint
ALTER TABLE "adset_edit_logs" ADD COLUMN IF NOT EXISTS "previous_start_time" text;--> statement-breakpoint
ALTER TABLE "adset_edit_logs" ADD COLUMN IF NOT EXISTS "new_start_time" text;--> statement-breakpoint
ALTER TABLE "adset_edit_logs" ADD COLUMN IF NOT EXISTS "previous_end_time" text;--> statement-breakpoint
ALTER TABLE "adset_edit_logs" ADD COLUMN IF NOT EXISTS "new_end_time" text;--> statement-breakpoint
ALTER TABLE "campaign_edit_logs" ADD COLUMN IF NOT EXISTS "adset_schedule_changes" jsonb;--> statement-breakpoint
DO $$ BEGIN
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "backoffice_magic_links_email_idx" ON "backoffice_magic_links" USING btree ("email");
...
export function FinanceOverview({ summary, window }: FinanceOverviewProps) {
  const netIsComplete =
      ...
      <section className="overflow-hidden rounded-xl border bg-card shadow-xs">
        <div className="p-5 sm:p-6">
          ...
          <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
            ...
            {formatFinanceNumber(summary.activeSubscriptions)} planos ativos,
            incluindo contratos anuais e acessos PIX vigentes.
          </p>
          ...
          <dl className="mt-6 grid grid-cols-2 gap-4 border-t pt-4 sm:grid-cols-4 sm:divide-x">
            ...
            <div className="sm:pl-3">
              <dt className="text-[10px] text-muted-foreground">Ticket médio</dt>
              <dd className="mt-1 text-xs font-semibold tabular-nums sm:text-sm">
